    ...
    <section class="section">
        ...
        <div class="card card-warning">
            <div class="card-header">
                ...
                <form class="card-header-form" action="{{ route('tenant.search') }}" method="GET">
            ...
            <div class="card-body">
                ...
                <!-- The filter field -->
                <div class="mb-3">
                    <label for="statusFilter" class="form-label">Filter by Type:</label>
