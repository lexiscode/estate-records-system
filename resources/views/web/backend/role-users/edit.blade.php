    ...
    <section class="section">
        ...
        <div class="card card-primary">
                ...
                <form class="card-header-form">
                    <div class="input-group">
                        ...
                        <div class="card-header-action">
                            <a href="{{ route('role-user.index') }}" class="btn btn-primary">Back</a>
                        </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('role-user.update', $user->id) }}" class="needs-validation" novalidate="">
                    @csrf
                    @method('PUT')
